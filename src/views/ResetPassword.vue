...
export default {
  ...
  head: {
        ...
        meta: [
          { name: "description", content: "JesusKing account password forgot ?" },
          { name: "twitter:card", content: "summary_large_image" },
          { name: "twitter:creator", content: "@KofficielJ" },
          { name: "twitter:title",  content: `Reset password | ${process.env.APP_NAME}` },
          { name: "twitter:description",  content: "JesusKing account password forgot ?" },
          { name: "twitter:image", content: "/assets/img/apple-icon.png" },
          { property: 'fb:app_id', content: '123456789' },
          { property: 'og:title', content: `Reset password | ${process.env.APP_NAME}` },
          { property: "og:site_name", content: `${process.env.APP_NAME}` },
          { property: "og:url", content: `${process.env.BASE_URL||''}resetpassword/` },
          { property: "og:description", content:"JesusKing account password forgot ?" },
  ...
  props: {
    header: {
      type: String,
      default: require("../assets/img/can_pleure.jpeg")
    }
  },
  methods: {
