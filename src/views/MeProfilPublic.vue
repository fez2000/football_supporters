    ...
    head: {
        ...
        meta: function() {
            return [
                ...
                {
                    name: "twitter:title",
                    content: `${this.title} | ${this.APP_NAME}`
                },
                { name: "twitter:description", content: this.description },
                {
                    name: "twitter:image",
                    content: "/assets/img/apple-icon.png"
                },
                {
                    property: "og:title",
                    content: `${this.title} | ${this.APP_NAME}`
    ...
    computed: {
        ...
        title() {
            return this.me
                ...
                ? i18n.tc("profilPublic.notFound")
                : i18n.tc("profilPublic.connectedProfil");
        },
        description() {
            return this.me
                ? i18n.tc("profilPublic.join") +
                      " " +
                      this.me.name +
                      " " +
                      i18n.tc("profilPublic.on") +
                      " " +
                      this.APP_NAME +
                      " " +
                      i18n.tc("profilPublic.moreWeAre")
                : this.errors == "NotFound"
                ? i18n.tc("profilPublic.joinUser") +
                  " " +
                  this.APP_NAME +
                  " " +
                  i18n.tc("profilPublic.betterWorld")
                : i18n.tc("profilPublic.connectedProfil");
        }
    },
    watch: {
