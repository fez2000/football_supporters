  ...
  <div class="wrapper">
    ...
    <div class="main main-raised">
      <div  class="section profile-content">
        <div v-if="joueur" class="container">
          <div class="md-layout">
          ...
          <div class="description text-center">
            ...
            <froalaView v-model="joueur.description"></froalaView>
          </div>
...
export default {
  ...
  bodyClass: "profile-page",
    beforeRouteEnter (to, from, next) {
      ...
      .then(({data})=>{
          if(data.status){
              next(vm => vm.setData(data.joueur));
          }else{
  ...
  computed: {
    headerStyle() {
      if(this.joueur){
        if(this.joueur.image){
          if(this.joueur.image.src){
            return {
                backgroundImage: `url(/api/img/${this.joueur.image.src})`
              };
          }
        }
      }
    ...
    title(){
      ...
      return (this.joueur)?this.joueur.name:(this.errors == 'NotFound')?'Profil Not found':'you may be connected to see this profil';
    },
    description(){
      return (this.joueur)?'join ' + this.joueur.name + ' on ' + this.APP_NAME + ' more we are may we...':(this.errors == 'NotFound')?'Profil Not found, join another user of ' + this.APP_NAME+' to make better wolrd':'you may be connected to see this profil, let join us'
    },
    shema(){
      ...
      return {
        ...
        "image": this.BASE_URL+'api/img/'+ this.joueur.image.src,
        //"jobTitle": "Professor",
