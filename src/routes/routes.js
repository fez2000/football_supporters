...
const routes = [
  ...
  },
  {
    ...
    name: 'Members',
    components: {
      default: Members, header: MainNavbar, footer: MainFooter,
    },
    props: {
      header: { colorOnScroll: 50 },
    },
  ...
  },
  {
    ...
    name: 'login',
    components: {
      default: Login, header: MainNavbar, footer: MainFooter,
    },
    props: {
      header: { colorOnScroll: 50 },
    },
  },
  {
    ...
    name: 'Reset Password',
    components: {
      default: ResetPassword, header: MainNavbar, footer: MainFooter,
    },
    props: {
      header: { colorOnScroll: 50 },
    },
  ...
  },
  {
    path: '/me',
    name: 'profil',
    components: { default: MeProfilPublic, header: MainNavbar, footer: MainFooter },
    props: {
      header: { colorOnScroll: 400 },
      footer: { backgroundColor: 'black' },
    },
  ...
  },
  {
    ...
    components: { default: ProjectsLayout, header: MainNavbar, footer: MainFooter },
    props: {
      header: { colorOnScroll: 50 },
    },
  },
  {
    ...
    components: { default: ProjectProfil, header: MainNavbar, footer: MainFooter },
    props: {
      header: { colorOnScroll: 50 },
      footer: { backgroundColor: 'black' },
    },
