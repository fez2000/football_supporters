          ...
          <div class="md-collapse-wrapper">
            ...
            <md-list>
              ...
              >
                ...
                <md-tooltip :md-direction="($vuetify.breakpoint.xs)?'left':'bottom'"
              ...
              >
                ...
                <md-tooltip :md-direction="($vuetify.breakpoint.xs)?'left':'bottom'"
                  >Suivez nous sur linkedin</md-tooltip
                >
              </md-list-item>
              <md-list-item
              ...
              >
                ...
                <p class="hidden-lg">Notification</p>      
                <md-tooltip  :md-direction="($vuetify.breakpoint.xs)?'left':'bottom'"
                  >{{(notifsNb == 0)?"vous n'avez pas de notification":"vous avez " + notifsNb + " notification(s)"}}</md-tooltip
                >
              </md-list-item>
...
export default {
  ...
  beforeDestroy(){
    if(secureSocket){
      ...
      secureSocket.removeListener('reconnect_attempt', this.waitReconnectAttempt);
  ...
  methods: {
    ...
    countUnRead (data){ this.notifsNb = data},
    scrollToElement() {
    ...
    checkLogin(){
      if(this.login){
        this.$axios.get('/api/debut').then(({ data })=>{
          this.login = data.status;
          this.$Cookies.set('login',this.login)
        }).catch((err)=>{
          this.$root.$emit('neterror', { err: err, callback: this.checkLogin});
        })
      }
    }
  },
